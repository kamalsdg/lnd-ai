...
export interface ConversationBarProps {
  ...
  /**
   * Callback when conversation starts connecting
   */
  onConnecting?: () => void
...
>(
  (
    ...
    const conversation = useConversation({
      onConnect: () => {
        console.log("ConversationBar: Connected")
    ...
    const handleSendText = React.useCallback(() => {
      ...
      // Manually trigger onMessage for user's text input
      // The SDK doesn't automatically call onMessage for text inputs
      onMessage?.({ source: "user", message: messageToSend })
      
      setTextInput("")
      onSendMessage?.(messageToSend)
    }, [conversation, textInput, onSendMessage, onMessage])
